defmodule NestedInputsForWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NestedInputsForWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NestedInputsForWeb.Gettext, "errors", msg, opts)
    end
  end
